package aashan.hotel.controller;
...
import aashan.hotel.services.ReservationService;
import aashan.hotel.services.UserService;
...
public class HotelReservationController {
	...
	public String proceedReservation(@Valid @ModelAttribute("newRes") CurrentReservation currentReservation,
		...
		System.out.println("proceed-reservation calleddd....");
	...
	public String reservationsList(Model model) {	
		System.out.println(reservationService.getReservationsForLoggedUser());
