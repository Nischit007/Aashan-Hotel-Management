...
import aashan.hotel.repository.ReservationRep;
...
public class ReservationServiceImpl implements ReservationService {
	...
	public Collection<Reservation> getReservationsForLoggedUser() {
		System.out.println(userService.getLoggedUserId());
	...
	public void saveOrUpdateReservation(CurrentReservation currentReservation) {
		...
		reservation.setUser(userService.getLoggedUser());
		System.out.println("loged user "+userService.getLoggedUser());
	...
	public CurrentReservation reservationToCurrentReservationById(int resId) {
		...
		currentReservation.setUsertId(reservation.getId());
		...
		currentReservation.setUsertId(userService.getLoggedUserId());
